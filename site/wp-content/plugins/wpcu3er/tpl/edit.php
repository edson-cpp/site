...
<div class="wrap wrap-CU3ER">
	...
	<div class="block">
		...
		<div class="block-inner">
			<div class="transHalf noBorder">
				...
				<div class="inputs">
					<label for="name" style='width:45%'>Name:</label> <input type="text" style='width:45%' name="settings[name]" id="name" value="<?php echo $slideshow['name']; ?>" />
				</div>
				<div class="inputs">
					<label for="name" style='width:45%'>ID:</label> <span style="width:45%; margin-top:5px;"><?php echo $slideshow['id']; ?></span>
				</div>
	...
	<h3 class="title">Slides and Transitions</h3>
		...
		<div id="slidesAndTransitionsHolder" style="margin-top:40px">
			<?php $i = 0; ?>
					...
					<div class="transHalf">
						...
						<div class="inputs slide">
							...
							<div class="imageUrl">
								...
								<div class="inputs">
									<label for="use_image<?php echo $i; ?>" style="width:40%;">Use image:</label>
									<input type="checkbox" name="slide[<?php echo $i; ?>][use_image]" id="use_image<?php echo $i; ?>" style="float:left;margin-top:6px;" value="yes"<?php echo ($slide['use_image'] == 'yes') ? ' checked="checked"' : ''; ?> /> &nbsp;
								</div>
							</div>
						</div>
