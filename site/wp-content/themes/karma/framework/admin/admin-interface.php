...
<div id="main">
	...
	<div id="tt-options-content-wrap">
    	<h2 class="truethemes-admin-logo">
			<?php _e('Site Options','truethemes_localize'); ?> <a class="add-new-h2" href="https://support.truethemes.net" target="_blank">Theme Support &rarr;</a></h2>
      ...
      <!-- Remove this bottom save bar so IE8 plays nicely. You've forced the hand IE! :)
      ...
      <form action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" method="post" style="display:inline" id="ofform-reset">
          <a onclick="if ( confirm('CAUTION: Any and all settings will be lost! Click OK to completely reset all options.') ) {return true;}return false;" href="#" class="submitdelete deletion">Reset Options</a>
