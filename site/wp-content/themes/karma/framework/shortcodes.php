...
if(!empty($rss)):
$output .='<li><a title="'.$rss_title.'" class="rss" href="'.$rss.'">'.$rss_title.'</a></li>'; endif;
if(!empty($twitter)):
$output .='<li><a title="'.$twitter_title.'" class="twitter" href="'.$twitter.'">'.$twitter_title.'</a></li>'; endif;
if(!empty($facebook)):
$output .='<li><a title="'.$facebook_title.'" class="facebook" href="'.$facebook.'">'.$facebook_title.'</a></li>'; endif;
if(!empty($email)):
$output .='<li><a title="'.$email_title.'" class="email" href="'.$email.'">'.$email_title.'</a></li>'; endif;
if(!empty($flickr)):
$output .='<li><a title="'.$flickr_title.'" class="flickr" href="'.$flickr.'">'.$flickr_title.'</a></li>'; endif;
if(!empty($youtube)):
$output .='<li><a title="'.$youtube_title.'" class="youtube" href="'.$youtube.'">'.$youtube_title.'</a></li>'; endif;
if(!empty($linkedin)):
$output .='<li><a title="'.$linkedin_title.'" class="linkedin" href="'.$linkedin.'">'.$linkedin_title.'</a></li>'; endif;
if(!empty($pinterest)):
$output .='<li><a title="'.$pinterest_title.'" class="pinterest" href="'.$pinterest.'">'.$pinterest_title.'</a></li>'; endif;
if(!empty($instagram)):
$output .='<li><a title="'.$instagram_title.'" class="instagram" href="'.$instagram.'">'.$instagram_title.'</a></li>'; endif;
if(!empty($foursquare)):
$output .='<li><a title="'.$foursquare_title.'" class="foursquare" href="'.$foursquare.'">'.$foursquare_title.'</a></li>'; endif;
if(!empty($delicious)):
$output .='<li><a title="'.$delicious_title.'" class="delicious" href="'.$delicious.'">'.$delicious_title.'</a></li>'; endif;
if(!empty($digg)):
$output .='<li><a title="'.$digg_title.'" class="digg" href="'.$digg.'">'.$digg_title.'</a></li>'; endif;
if(!empty($google)):
$output .='<li class="google-plus"><a title="'.$google_title.'" class="google +" href="'.$google.'">'.$google_title.'</a></li>'; endif;
if(!empty($dribbble)):
$output .='<li><a title="'.$dribbble_title.'" class="dribbble" href="'.$dribbble.'">'.$dribbble_title.'</a></li>'; endif;
if(!empty($skype)):
$output .='<li><a title="'.$skype_title.'" class="skype" href="'.$skype.'">'.$skype_title.'</a></li>'; endif;
...
function truethemes_team_member($atts, $content = null) {
  ...
  $framesize = $style.'_'.$size;
	...
	$output.= truethemes_image_frame_constructor($style,"img-preload",$image_path,190,180,$framesize,$link_to_page,$target,$description);
...
$output .= '[raw]<ul class="tt-recent-posts"><li><a class="tt-recent-post-link" title="'.get_the_title().'" href="'.$truethemeslink.'">[/raw]';
...
if ('default' == $layout){ $output .= '[raw]</a></li></ul>[/raw]'; }
