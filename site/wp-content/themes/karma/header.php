...
//strip "px" from strings for balid HTML markup
...
if ('tt-logo-right' == $true_logo){
	$true_logo_class  = 'tt-logo-right';
} elseif ('tt-logo-center' == $true_logo){
	$true_logo_class  = 'tt-logo-center';
} else {
	$true_logo_class  = '';
}
...
<ul id="uber-menu-nav">
<?php wp_nav_menu(array('theme_location' => 'UberMenu' )); ?>
</ul>
<?php else: ?>
<ul id="menu-main-nav">
