...
function truethemes_register_required_plugins() {
	...
	$config = array(
		...
		'message' 			=> '<br /><h3>Frequently Asked Questions:</h3><ol style="padding:10px 0;"><li style="padding-bottom:12px;"><strong>How do I install the plugins listed below?</strong><br />Simply hover over each plugin that you\'d like to install and click <em>Install</em>.</li><li><strong>I\'m receiving an Error when trying to install the LayerSlider or Slider Revolution Plugins?</strong><br />These premium plugins are hosted on our Secure Amazon S3 server. Certain web servers do not allow for direct installation of files from an outside server, resulting in the error. We will need to manually install these plugins for you. Please kindly submit a ticket on our <a href="https://support.truethemes.net/login" target="_blank">Secure Online HelpDesk</a> and we\'ll gladly get you up and running.</li></ol><br />',							// Message to output right before the plugins table
		'strings'      		=> array(
