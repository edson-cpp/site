...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		//@since 4.0.1 dev 3, mod by denzel to prevent notice from showing to non-admin users.
		//the endif is at the end of this function.
		if(current_user_can('install_plugins')):
		...
		endif; //@since 4.0.1 dev 3, mod by denzel, endif for current_user_can('install_plugins') check at beginning of this function.
		}
