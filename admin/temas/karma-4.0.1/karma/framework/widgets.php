...
<li><a href="<?php echo $networks[$network];?>" class="<?php echo strtolower($network);?>" title="<?php echo $network;?>"><?php echo str_replace(" ", '', $network);?></a></li>
...
<?php endif;endforeach;?>
   ...
   function form($instance)
   {
      ...
      $rss        = $twitter = $facebook = $flickr = $youtube = $linkedin = $pinterest = $instagram = $foursquare = $delicious = $digg = $google = $dribbble = $skype = $display = $vectorcheckbox = $social_title_checkbox = $colorcheckbox = '';
      $rss        = $instance['rss'];
...
<p><label for="<?php echo $this->get_field_id('title_link');?>"><?php _e('Title Link:', 'truethemes_localize');?></label>     
