...
lang : {
	...
	focusTitle : 'Click para vir a frente',
	fullExpandTitle : 'Maximizar (f)',
	creditsText : '',
	...
	moveTitle : 'Mover',
	fullExpandText : 'Tela Cheia',
	restoreTitle : 'Click para fechar, click e segura para mover. Use as setas para voltar ou avançar.'
},
...
skin : {
	contentWrapper:
		'<div class="highslide-header"><ul>'+
			...
			'</li>'+
			'<li class="highslide-close" style="padding-left:25px;">'+
