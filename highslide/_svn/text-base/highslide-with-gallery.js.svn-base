...
lang : {
	...
	number: 'Image %1 of %2',
	restoreTitle : 'Click para fechar a imagem, click e segure para mover. Use as setas para avançar ou voltar.'
},
