...
try{
	...
	if($valido === true){
		...
		$sessao->recuperaDados($email); // envia o email para efetuar a confirmação de senha
		$msg = "Sua senha foi alterada com sucesso, enviamos seus dados para seu email, obrigado!";
	}else{
		Throw new Exception("Dados de cofirmação inválidos, por favor tente novamente!");	
	}
